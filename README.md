...
- saves the final comparison CSV in `outputs/metrics/all_model_comparison.csv`
...
- saves `outputs/metrics/top5_feature_importance.csv`
- saves `outputs/figures/top5_feature_importance.png`
...
- saves predictions in `outputs/predictions/final_test_predictions.csv`
...
The project successfully developed a machine learning workflow for predicting irrigation need levels in Nepal. Among all evaluated models, the **baseline Random Forest classifier** achieved the strongest overall performance and was selected as the final model.